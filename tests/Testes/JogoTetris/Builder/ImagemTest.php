...
final class ImagemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIfWithAndAbsentImageICanConstructAnDefaultImage()
    {
        ...
        $this->assertFileExists($img->imagem, 'Verifique se no construtor da classe Imagem ou se na proprieade public static $pathimgs o caminho da imagem o levam ao caminho correto da pasta imagens na sua app OU se a extensao informada e permitida');
    }
    ...
    public function testIfWithAndExistingImageButWithWrongExtensionTheProgramWillSetAMessageInImageProperty()
    {
        ...
        $this->assertSame('.exe is not permitted as an image extension!', $img->imagem);
    }
}
